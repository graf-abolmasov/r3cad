...
<head>
    ...
    <title>${plainDrawAreaInstance.label} - <g:message code="plainDrawArea.edit.title"/></title>
</head>

<body>
<div class="page-header"><h2><g:message code="plainDrawArea.edit.title"/></h2></div>
...
<g:hasErrors bean="${plainDrawAreaInstance}">
    <g:eachError bean="${plainDrawAreaInstance}" var="error">
...
<g:form action="update" role="form" method="post">
    <g:hiddenField name="id" value="${plainDrawAreaInstance?.id}" />
    <g:hiddenField name="version" value="${plainDrawAreaInstance?.version}" />
