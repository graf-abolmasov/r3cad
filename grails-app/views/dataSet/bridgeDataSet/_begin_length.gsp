...
,Editor({
    ...
    set: function (data) {
        ...
        data.endLocation_plus=data.plus+dplus
        if (data.endLocation_plus>=${Location.METER_IN_PK}){
            data.endLocation_plus=data.endLocation_plus-100
            data.endLocation_pk=data.pk + dpk + 1
        }
        else{
            data.endLocation_pk=data.pk + dpk
        }
        if (data.endLocation_pk>9){
            data.endLocation_pk=data.endLocation_pk-10
            data.endLocation_km=data.km + dkm + 1
        }
        else {
            data.endLocation_km=data.km + dkm
        }
