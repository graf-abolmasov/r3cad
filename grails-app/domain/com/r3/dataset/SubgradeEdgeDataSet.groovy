...
class SubgradeEdgeDataSet extends BaseDataSet implements ProfileDrawingAware {

    final DataSetMetaInfo metaInfo = new DataSetMetaInfo(false, true)

    private static final String DEFAULT_TEMPLATE = "subgrade_edge"
    ...
    static hasMany = [values: SubgradeEdgeDataEntry]

    SortedSet<SleepersDataEntry> values

    SubgradeEdgeDataSet(@NotNull final Project project,
